...
class InstructionsTab extends StatelessWidget{
  ...
  const InstructionsTab({Key? key, required this.index, required this.listOfExercise}) : super(key: key);
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            verticalSpace(15),
                            Text(
                              '${listOfExercise[index].instructions}',
