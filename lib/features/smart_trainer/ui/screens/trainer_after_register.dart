...
class TrainerAfterRegister extends StatelessWidget{
  const TrainerAfterRegister({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  const ContainerOfMessage(
                    text: 'Congratulations! 🎉 You\'re all set to embark on your personalized fitness journey.',
                  ),
                  verticalSpace(20),
                  const ContainerOfMessage(
